                    ...
                    parts.push(
                        <ReactMarkdown
                            ...
                            components={{
                                ...
                                code: ({children}) => <code
                                    className="bg-gray-100 dark:bg-gray-700 px-2 py-1 rounded text-xs font-mono">{children}</code>,
                                pre: ({children}) => <pre
                                    className="bg-gray-100 dark:bg-gray-700 p-3 rounded-lg my-2 overflow-x-auto text-xs break-words">{children}</pre>,
                                ul: ({children}) => <ul
                                    className="list-disc list-inside mb-2 space-y-1">{children}</ul>,
                                ol: ({children}) => <ol
                                    className="list-decimal list-inside mb-2 space-y-1">{children}</ol>,
                    ...
                    <div>
                        <ReactMarkdown
                            components={{
                                ...
                                em: ({children}) => <em className="italic">{children}</em>,
                                code: ({children}) => <code
                                    className="bg-gray-100 dark:bg-gray-700 px-2 py-1 rounded text-xs font-mono break-all">{children}</code>,
                                pre: ({children}) => <pre
                                    className="bg-gray-100 dark:bg-gray-700 p-3 rounded-lg my-2 overflow-x-auto text-xs break-words">{children}</pre>,
                                ul: ({children}) => <ul
                                    className="list-disc list-inside mb-2 space-y-1">{children}</ul>,
    ...
    const renderDetailModal = () => {
        ...
        return (
            <div
                ...
                >
                    <div
                        className="bg-white dark:bg-gray-800 rounded-lg p-6 max-w-4xl max-h-[80vh] overflow-auto border border-gray-200 dark:border-gray-700">
                        ...
                        <div className="space-y-4">
                            ...
                            <div className="text-gray-900 dark:text-gray-100">
                                <strong
                                    className="text-gray-700 dark:text-gray-300">시간:</strong> {formatTime(selectedLog.timestamp)}
                            </div>
                            ...
                            {type === 'tool_result' && data.diff_info && (
                                <div>
                                    ...
                                    <pre
                                        className="bg-gray-100 dark:bg-gray-800 p-3 rounded-lg overflow-x-auto text-xs font-mono">
                  {data.diff_info}
                </pre>
                                </div>
                            )}
            ...
            <div className="flex-1 overflow-y-auto px-8 py-3 space-y-2 custom-scrollbar dark:chat-scrollbar">
                {isLoading && (
                    <div className="flex items-center justify-center h-32 text-gray-400 dark:text-gray-600 text-sm">
                        <div className="flex flex-col items-center">
                            <div
                                className="animate-spin rounded-full h-6 w-6 border-b-2 border-gray-900 dark:border-white mb-2 mx-auto"></div>
                ...
                <AnimatePresence>
                                ...
                                >
                                    {message.role === 'user' ? (
                                        ...
                                        <div className="flex justify-end">
                                            <div
                                                className="max-w-[80%] bg-gray-100 dark:bg-gray-800 rounded-lg px-4 py-3">
                                                <div className="text-sm text-gray-900 dark:text-white break-words">
                                                                                ...
                                                                                {attachments.map((attachment: any, idx: number) => {
                                                                                    ...
                                                                                    return (
                                                                                        <div key={idx}
                                                                                            ...
                                                                                            <div
                                                                                                className="w-40 h-40 bg-gray-200 dark:bg-gray-700 rounded-lg overflow-hidden border border-gray-300 dark:border-gray-600">
                                                                                                <img
                                                                                                    src={imageUrl}
                                                                                                    alt={`Image ${idx + 1}`}
                                                  ...
                                                  `;
                                                                                            ...
                                                                                            <div
                                                                                                className="absolute inset-0 bg-black bg-opacity-0 group-hover:bg-opacity-30 rounded-lg transition-opacity flex items-center justify-center">
                                            <span
                                                className="text-white text-sm font-medium opacity-0 group-hover:opacity-100 transition-opacity bg-black bg-opacity-60 px-2 py-1 rounded">
                                              #{idx + 1}
                                            </span>
                                                                                            </div>
                                                                                            {/* Tooltip with filename */}
                                                                                            <div
                                                                                                className="absolute bottom-full mb-1 left-1/2 transform -translate-x-1/2 bg-gray-900 text-white text-xs px-2 py-1 rounded opacity-0 group-hover:opacity-100 transition-opacity pointer-events-none whitespace-nowrap z-10">
                                                                                                {attachment.name}
                                                                                            </div>
                                                                                        </div>
                                                                                    );
                                                                                ...
                                                                                {imagePaths.map((path, idx) => {
                                                                                    ...
                                                                                    return (
                                                                                        <div key={idx}
                                                                                             className="relative group">
                                                                                            <div
                                                                                                className="w-40 h-40 bg-gray-200 dark:bg-gray-700 rounded-lg overflow-hidden border border-gray-300 dark:border-gray-600 flex items-center justify-center">
                                                                                                <svg
                    ...
                    {logs.filter(log => {
                        ...
                        <div key={`log-${log.id}-${index}`} className="mb-4 w-full cursor-pointer"

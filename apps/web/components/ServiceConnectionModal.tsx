            ...
            case 'github':
                return {
                    ...
                    instructions: [
                        ...
                        "Enter a descriptive name (e.g., 'Vrabby Integration')",
    ...
    return (
        <AnimatePresence>
            <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
                ...
                <div
                    className="relative bg-white dark:bg-gray-800 rounded-2xl shadow-2xl w-full max-w-2xl max-h-[90vh] overflow-auto">
                    <motion.div
                      ...
                      Token Connected
                                        ...
                                        <div className="text-sm text-gray-600 dark:text-gray-400">
                                            ...
                                            {savedToken.last_used && (
                                                <p className="text-xs">Last
                                                    used: {new Date(savedToken.last_used).toLocaleString()}</p>
                                            )}
                                        </div>
                                    </div>
                                    ...
                                    {projectId && (
                                        <div className="space-y-2">
                                            <h3 className="text-sm font-medium text-gray-700 dark:text-gray-300">Available
                                                Actions</h3>
                                            {provider === 'github' && (
                                                <button
                                        ...
                                        <div className="space-y-4">
                                            <div>
                                                ...
                                                <p className="text-xs text-gray-500 dark:text-gray-400 mt-2">
                                                    This will replace your current token. The old token will be
                                                    permanently removed.
                                                </p>
                                            </div>
                                ...
                                <div className="space-y-6">
                                    <div
                                        ...
                                        <p className="text-xs text-gray-700 dark:text-gray-300 mb-3">
                                            To use {providerInfo.title} integration, you need to create
                                            a {providerInfo.tokenName} first.
                                        </p>
                                        <a
                        ...
                        <span
                            className="flex-shrink-0 w-5 h-5 bg-gray-100 dark:bg-gray-600 text-gray-900 dark:text-white rounded-full flex items-center justify-center text-xs font-medium">
                          {index + 1}
                        </span>
                                                    <span>{step}</span>
                                                </li>
                                    ...
                                    <div className="space-y-4">
                                        <div>
                                            ...
                                            />
                                            <p className="text-xs text-gray-500 dark:text-gray-400 mt-2">
                                                Your token will be encrypted and stored securely. You can delete it
                                                anytime.
                                            </p>
                                        </div>

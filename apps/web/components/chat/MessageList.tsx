                                                ...
                                                {!isUser && hasThinking && messageIndex === 0 && (
                                                    <div className="mb-2">
                                                        ...
                                                        >
                                                            ...
                                                            <span
                                                                className="font-normal">Thought for {thinkingDuration} seconds</span>
                                                        </button>
                                                        ...
                                                        {isThoughtExpanded && (
                                                            ...
                                                            >
                                                                <div
                                                                    className="mt-2 p-3 rounded-lg bg-gray-50 dark:bg-gray-800/50 border border-gray-200 dark:border-gray-700">
                                                                    <div
                                                        ...
                                                        {message.metadata_json && Array.isArray((message as any).metadata_json.attachments) && (
                                                            <div className="mt-2 grid grid-cols-3 gap-2">
                                                                {(message as any).metadata_json.attachments.map((att: any, idx: number) => {
                                                                    ...
                                                                    return (
                                                                        <div key={idx}
                                                                             className="w-20 h-20 overflow-hidden rounded-md border border-gray-200 dark:border-gray-600 bg-white dark:bg-gray-800">
                                                                            {fullUrl ? (
                                                                                ...
                                                                                <div
                                                                                    className="w-full h-full flex items-center justify-center text-xs opacity-60">img</div>
                                                                            )}
                                                                        </div>
                                                                    );
                                                                })}
                ...
                <div className="flex justify-start">
                    <motion.div initial={{opacity: 0}} animate={{opacity: 1}}>
                        <div className="space-y-2">
                            {/* Thinking indicator */}
                            <div
                                className="flex items-center gap-2 text-xs px-3 py-1.5 rounded-lg bg-gray-100 dark:bg-gray-800 text-gray-600 dark:text-gray-400">

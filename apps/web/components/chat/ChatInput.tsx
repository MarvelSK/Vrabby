        ...
        >
          ...
          />
                    {isDragOver && projectId && preferredCli !== 'cursor' && preferredCli !== 'qwen' && (
                        <div
                            className="pointer-events-none absolute inset-0 bg-blue-50/90 dark:bg-blue-900/30 rounded-md flex items-center justify-center z-10 border-2 border-dashed border-blue-500">

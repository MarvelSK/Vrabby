    ...
    return (
        <div className="my-2 text-sm text-gray-500 dark:text-gray-500">
            ...
            >
                ...
                <span
                    className="italic">{formatThinkingContent(firstLine.replace(/^\*\*/, '').replace(/\*\*$/, ''))}</span>
            </div>
            ...
            {hasMoreContent && (
                <AnimatePresence>
                    {isExpanded && (
                        ...
                        >
                            <div
                                className="italic text-gray-500 dark:text-gray-500 leading-relaxed whitespace-pre-wrap">

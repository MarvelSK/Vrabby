    ...
    return (
        <div className="p-6 space-y-6">
            <div>
                ...
                <p className="text-sm text-gray-600 dark:text-gray-400 mb-4">Connect GitHub, Supabase and Vercel with a
                    consistent, polished experience.</p>
                ...
                <div className="space-y-4">
                    {services.map(service => (
                        ...
                        >
                            <div
                                className="absolute inset-x-0 -top-px h-px bg-gradient-to-r from-transparent via-gray-200 dark:via-white/10 to-transparent"/>
                            <div
                                className="p-5 flex flex-col sm:flex-row sm:items-center gap-4 sm:gap-6 justify-between">
                                <div className="flex items-center gap-4 flex-1 min-w-0">
                                    <div
                                        className="w-10 h-10 rounded-xl ring-1 ring-inset ring-gray-200 dark:ring-white/10 bg-gray-50 dark:bg-white/5 text-gray-700 dark:text-gray-300 flex items-center justify-center">
                                    ...
                                    <div className="min-w-0">
                                        <div className="flex items-center gap-3 mb-1 min-w-0">
                                            ...
                                            {service.connected && (
                                                <span
                                                    className="inline-flex items-center gap-1.5 px-2.5 py-0.5 rounded-full text-xs font-medium text-emerald-700 dark:text-emerald-400 bg-emerald-100 dark:bg-emerald-900/30 whitespace-nowrap">
                          ...
                          Connected
                                            ...
                                            {!service.connected && tokenStatus[service.id as keyof typeof tokenStatus] === false && (
                                                <span
                                                    className="inline-flex items-center gap-1.5 px-2.5 py-0.5 rounded-full text-xs font-medium text-amber-700 dark:text-amber-400 bg-amber-100 dark:bg-amber-900/30 whitespace-nowrap">
                          <svg className="w-3.5 h-3.5" viewBox="0 0 20 20" fill="currentColor"><path fillRule="evenodd"
                          ...
                          Token needed
                                    ...
                                    <div
                                        className="flex items-center gap-2 sm:flex-shrink-0 w-full sm:w-auto sm:justify-end">
                                        {service.connected ? (
                                            <button
                                            ...
                                            <button
                                                onClick={() => {
                                                    if (onOpenGlobalSettings) onOpenGlobalSettings();
                                                }}

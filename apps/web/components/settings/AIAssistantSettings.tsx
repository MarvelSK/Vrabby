                  ...
                  <span className="text-lg font-semibold text-gray-900 dark:text-white">
                    {selectedCLIOption?.name || preference?.preferred_cli || 'Not configured'}
                                    ...
                                    {selectedCLIOption?.configured ? (
                                        <span
                                            className="text-xs px-2 py-1 bg-green-100 text-green-700 dark:bg-green-900/20 dark:text-green-400 rounded">
                      Configured
                    </span>
                                    ) : (
                                        <span
                                            className="text-xs px-2 py-1 bg-yellow-100 text-yellow-700 dark:bg-yellow-900/20 dark:text-yellow-400 rounded">
                      Not Configured
                    </span>
                                    )}
                                </div>

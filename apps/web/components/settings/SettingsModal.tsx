...
export function SettingsModal({isOpen, onClose, title, icon, children}: SettingsModalProps) {
    ...
    return (
        <div className="fixed inset-0 z-50 overflow-hidden">
            ...
            <div
                className="absolute inset-y-0 right-0 max-w-3xl w-full bg-white dark:bg-gray-900 shadow-2xl flex flex-col">
                {/* Header */}
                <div
                    className="px-6 py-5 bg-gradient-to-r from-gray-50 to-gray-100 dark:from-gray-800 dark:to-gray-900 border-b border-gray-200 dark:border-gray-800">
                    <div className="flex items-center justify-between">
                        <div className="flex items-center gap-3">
                            {icon && (
                                <div
                                    className="p-2 bg-white dark:bg-gray-800 rounded-lg shadow-sm text-gray-600 dark:text-gray-400">
                                    {icon}
                                </div>
                            )}
                            <div>

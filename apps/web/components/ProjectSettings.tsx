        ...
        models: [
            {
                ...
                description: 'Most intelligent model for complex coding tasks'
            },
        ...
        models: [
            {
                id: 'gemini-2.5-pro',
                name: 'Gemini 2.5 Pro',
                description: 'State-of-the-art thinking model with adaptive reasoning'
            },
    ...
    },
    {
        ...
        models: [
            ...
            {id: 'gpt-4.1', name: 'GPT-4.1', description: 'Major improvements in coding and long-context'},
            {
                id: 'o3-mini',
                name: 'OpenAI o3-mini',
                description: 'Cost-efficient reasoning model for coding, math, and science'
            },
        ],
    ...
    return (
        <AnimatePresence>
            <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
                ...
                <div
                    className="relative bg-white dark:bg-gray-800 rounded-2xl shadow-2xl w-full max-w-6xl max-h-[95vh] overflow-hidden">
                    <motion.div
                        ...
                        <div className="p-6 border-b border-gray-200 dark:border-gray-700">
                            <div className="flex items-center justify-between">
                                <div className="flex items-center gap-3">
                                    <div
                                        className="w-8 h-8 bg-[#DE7356]/10 dark:bg-[#DE7356]/20 text-[#DE7356] dark:text-[#DE7356] rounded-lg flex items-center justify-center">
                                        <svg width="20" height="20" viewBox="0 0 24 24" fill="none"
                                            ...
                                            <path d="M8 21v-4a2 2 0 0 1 2-2h4a2 2 0 0 1 2 2v4" stroke="currentColor"
                                                  strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
                                            <path d="M21 9V7a2 2 0 0 0-2-2H5a2 2 0 0 0-2 2v2" stroke="currentColor"
                                                  strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
                                        </svg>
                                    </div>
                                    <div>
                        ...
                        <div className="p-8 max-h-[70vh] overflow-y-auto">
                            {activeTab === 'general' && (
                                <div className="space-y-6">
                                    <div>
                                        <h3 className="text-lg font-medium text-gray-900 dark:text-white mb-4">Project
                                            Information</h3>
                                        <div className="bg-gray-50 dark:bg-gray-700 rounded-lg p-4 space-y-3">
                                            <div className="grid grid-cols-2 gap-4">
                                                <div>
                                                    <p className="text-sm font-medium text-gray-600 dark:text-gray-400">Project
                                                        ID</p>
                                                ...
                                                <div>
                                                    ...
                                                    <div className="flex items-center gap-2">
                                                        ...
                                                        <span
                                                            className="text-sm text-gray-900 dark:text-white">Active</span>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            {projectInfo && (
                                                <div className="grid grid-cols-2 gap-4">
                                                    ...
                                                    <div>
                                                        <p className="text-sm font-medium text-gray-600 dark:text-gray-400">Last
                                                            Updated</p>
                                                        <p className="text-sm text-gray-900 dark:text-white">
                                    ...
                                    <div>
                                        <h3 className="text-lg font-medium text-gray-900 dark:text-white mb-4">Development
                                            Settings</h3>
                                        <div className="space-y-3">
                                            <div
                                                ...
                                                <div>
                                                    ...
                                                    <p className="text-sm text-gray-600 dark:text-gray-400">Automatically
                                                        start preview when opening project</p>
                                                </div>
                                            ...
                                            <div
                                                className="flex items-center justify-between p-4 bg-gray-50 dark:bg-gray-700 rounded-lg">
                                                <div>
                                                    <p className="font-medium text-gray-900 dark:text-white">Hot
                                                        reload</p>
                                                    <p className="text-sm text-gray-600 dark:text-gray-400">Enable hot
                                                        reloading for code changes</p>
                                                </div>
                                                <input type="checkbox" className="rounded" defaultChecked/>
                                            </div>
                                        </div>
                            ...
                            {activeTab === 'ai-assistant' && (
                                <div className="space-y-6">
                                    <div>
                                        <h3 className="text-lg font-medium text-gray-900 dark:text-white mb-4">Current
                                            AI Assistant (Read-only)</h3>
                                        <div className="mb-6">
                                            {projectCLIInfo ? (
                                                <div
                                                    className="p-4 rounded-xl border-2 border-gray-900 dark:border-white bg-gray-50 dark:bg-gray-700">
                              ...
                              <span className="text-xl">
                                {CLI_OPTIONS.find(cli => cli.id === projectCLIInfo.current_preference)?.icon || '🤖'}
                                                            ...
                                                            <div
                                                                className="px-2 py-1 bg-gray-200 dark:bg-gray-600 rounded-full text-xs text-gray-600 dark:text-gray-300">
                                                                Active
                                                            </div>
                                                        </div>
                                                        <div
                                                    ...
                                                    <div className="text-xs text-gray-500 dark:text-gray-400">
                                                        ...
                                                        {projectCLIInfo.current_model && (
                                                            <div className="mt-1">
                                                                Current Model: <span
                                                                className="font-medium">{projectCLIInfo.current_model}</span>
                                                            </div>
                                                        )}
                                                    </div>
                                                </div>
                                                ...
                                                <div
                                                    className="p-4 rounded-xl border-2 border-gray-200 dark:border-gray-600 bg-gray-50 dark:bg-gray-700">
                                                    <div className="animate-pulse flex items-center gap-3">
                                                        <div
                                                            className="w-6 h-6 bg-gray-300 dark:bg-gray-600 rounded"></div>
                                                        <div
                                                            className="h-4 bg-gray-300 dark:bg-gray-600 rounded w-32"></div>
                                                    </div>
                                                </div>
                                            )}
                                        </div>
                                    ...
                                    <div
                                        className="bg-gray-50 dark:bg-gray-700 rounded-xl p-6 border border-gray-200 dark:border-gray-600 mb-6">
                                        <div className="flex items-center justify-between">
                                            <div>
                                                <h3 className="font-semibold text-gray-900 dark:text-white mb-1">Enable
                                                    Fallback for This Project</h3>
                                                <p className="text-sm text-gray-500 dark:text-gray-400">
                                                    Automatically try other AIs when this project's preferred CLI is
                                                    unavailable
                                                </p>
                                            </div>
                                        ...
                                        <div className="mt-2 text-xs text-gray-500 dark:text-gray-400">
                                            This setting was configured when the project was created and cannot be
                                            changed.
                                        </div>
                                    </div>
                                        ...
                                        <div className="flex items-start gap-3">
                                            ...
                                            <div>
                                                ...
                                                <p className="text-sm text-blue-700 dark:text-blue-300 mt-1">
                                                    Each project uses the CLI Agent selected during creation. To
                                                    configure multiple CLI Agents or change global settings, use Global
                                                    Settings from the main page.
                                                </p>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div className="space-y-6">
                                    <div>
                                        ...
                                        <p className="text-sm text-gray-600 dark:text-gray-400 mb-6">
                                            Connect this project to specific GitHub repositories, Supabase projects, and
                                            Vercel deployments.
                                        </p>
                                            ...
                                            <div className="p-4 bg-gray-50 dark:bg-gray-700 rounded-lg">
                                                <div className="flex items-center justify-between mb-4">
                                                    <div className="flex items-center gap-3">
                                                        ...
                                                        <div>
                                                            <p className="font-medium text-gray-900 dark:text-white">Supabase
                                                                Project</p>
                                                            <p className="text-sm text-gray-600 dark:text-gray-400">
                                                                {serviceConnections.find(conn => conn.provider === 'supabase') ? (
                                                                    <>Connected: <a
                                            ...
                                            <div className="p-4 bg-gray-50 dark:bg-gray-700 rounded-lg">
                                                <div className="flex items-center justify-between mb-4">
                                                    <div className="flex items-center gap-3">
                                                        ...
                                                        <div>
                                                            <p className="font-medium text-gray-900 dark:text-white">Vercel
                                                                Deployment</p>
                                                            <p className="text-sm text-gray-600 dark:text-gray-400">
                                                                {serviceConnections.find(conn => conn.provider === 'vercel') ? (
                                                                    <>Connected: <a
                                            ...
                                            <div className="flex">
                                                ...
                                                <div className="ml-3">
                                                    ...
                                                    <div className="mt-2 text-sm text-amber-700 dark:text-amber-300">
                                                        <p>
                                                            Make sure you have configured your API tokens in Global
                                                            Settings before connecting services to this project.
                                                        </p>
                                                    </div>
                                                </div>
                                            </div>
                            ...
                            {activeTab === 'danger' && (
                                <div className="space-y-6">
                                    <div>
                                        <h3 className="text-lg font-medium text-red-600 dark:text-red-400 mb-4">Danger
                                            Zone</h3>
                                        <div
                                            className="border border-red-200 dark:border-red-800 rounded-lg p-6 bg-red-50 dark:bg-red-900/10">
                                            <div className="space-y-4">
                                                <div>
                                                    <h4 className="font-medium text-red-900 dark:text-red-200 mb-2">Delete
                                                        Project</h4>

        ...
        models: [
            {
                ...
                description: 'Superior coding with 1M context window',
                supportsImages: true
            },
            {
                id: 'claude-opus-4.1',
        ...
        models: [
            {
                id: 'gpt-5',
                name: 'GPT-5',
                description: 'Best coding model with expert-level intelligence',
                supportsImages: true
            },
            {
                id: 'claude-sonnet-4.5',
                name: 'Claude Sonnet 4.5',
                description: 'State-of-the-art coding capabilities',
                supportsImages: true
            },
            {
                id: 'claude-opus-4.1',
        ...
        models: [
            {
                ...
                description: 'Most agentic coding model with 1M context',
                supportsImages: true
            },
            {
                id: 'qwen2.5-coder-32b',
                name: 'Qwen2.5-Coder 32B',
                description: 'SOTA open-source coding model',
        ...
        models: [
            {
                id: 'gpt-5',
                name: 'GPT-5',
                description: 'Smartest coding model with built-in thinking',
                supportsImages: true
            },
            {
                id: 'gpt-4.1',
                name: 'GPT-4.1',
                description: 'Major improvements in coding and long-context',
                supportsImages: true
            },
            {
                id: 'o4-mini',
...
export default function CreateProjectModal({open, onClose, onCreated, onOpenGlobalSettings}: CreateProjectModalProps) {
    ...
    async function submit() {
        ...
        if (!finalCLI || !finalModel) {
            console.error('Missing CLI or model selection:', {
                finalCLI,
                finalModel,
                useDefaultSettings,
                globalSettings
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4" onKeyDown={handleKeyDown}>
            ...
            >
                ...
                <div className="p-6">
                    ...
                    <div
                        className="bg-gray-50 dark:bg-gray-700 rounded-xl p-4 border border-gray-200 dark:border-gray-600 mb-4">
            <textarea
                value={prompt}
                        ...
                        <div className="flex items-start gap-3">
                            ...
                            <div className="flex-1">
                                ...
                                <p className="text-xs text-gray-500 dark:text-gray-400 mt-1">
                                    {globalSettings ? (
                                        <>Use {enabledCLIs.find(cli => cli.id === globalSettings.default_cli)?.name || 'default'} AI
                                            with your preferred model. Change this in <button
                                                onClick={() => {
                                                    onClose();
                        ...
                        {!useDefaultSettings && (
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                    ...
                                    <div className="relative">
                                        ...
                                        >
                                            <div className="flex items-center gap-3">
                                                ...
                                                <div>
                                                    <div
                                                        className="font-medium text-gray-900 dark:text-white">{selectedCLIOption?.name}</div>
                                                    <div
                                                        className="text-xs text-gray-500 dark:text-gray-400">{selectedCLIOption?.description}</div>
                                                </div>
                                            </div>
                                            <svg width="16" height="16" viewBox="0 0 24 24" fill="none"
                                                 xmlns="http://www.w3.org/2000/svg"
                                                 className={`transition-transform ${showCLIDropdown ? 'rotate-180' : ''}`}>
                                                        ...
                                                        return (
                                                            ...
                                                            >
                                                                ...
                                                                <div className="flex-1">
                                                                    <div className="flex items-center gap-2">
                                                                        <div
                                                                            className="font-medium text-gray-900 dark:text-white">{cli.name}</div>
                                                                        {isInstalled ? (
                                                                            <span
                                                                                className="text-xs bg-green-100 dark:bg-green-900/30 text-green-600 dark:text-green-400 px-2 py-1 rounded-full">
                                        ✓
                                      </span>
                                                                        ) : (
                                                                            <span
                                                                                className="text-xs bg-yellow-100 dark:bg-yellow-900/30 text-yellow-600 dark:text-yellow-400 px-2 py-1 rounded-full">
                                        !
                                      </span>
                                                                        )}
                                                                    </div>
                                                                    <div
                                                                        className="text-xs text-gray-500 dark:text-gray-400">{cli.description}</div>
                                                                </div>
                                                            </button>
                                                        );
                                                    })}
                                    ...
                                    <div className="relative">
                                        ...
                                        >
                                            <div>
                                                <div className="flex items-center gap-2">
                                                    <div
                                                        className="font-medium text-gray-900 dark:text-white">{selectedModelOption?.name}</div>
                              ...
                              📷
                                                ...
                                                <div
                                                    className="text-xs text-gray-500 dark:text-gray-400">{selectedModelOption?.description}</div>
                                            </div>
                                            <svg width="16" height="16" viewBox="0 0 24 24" fill="none"
                                                 xmlns="http://www.w3.org/2000/svg"
                                                    ...
                                                    {selectedCLIOption.models.map((model) => (
                                                        ...
                                                        >
                                                            <div className="flex items-center gap-2 mb-1">
                                                                <div
                                                                    className="font-medium text-gray-900 dark:text-white">{model.name}</div>

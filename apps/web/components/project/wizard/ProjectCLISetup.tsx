        ...
        <div className="space-y-6">
            ...
            <div className="space-y-3">
                {CLI_OPTIONS.filter(option => option.enabled !== false).map((option) => (
                    ...
                    {option.name}
                                    ...
                                    {option.id === 'claude' && (
                                        <span
                                            className="text-xs px-2 py-1 bg-blue-100 text-blue-700 dark:bg-blue-900/20 dark:text-blue-400 rounded">
                      Recommended
                    </span>
                                    )}
                                </div>
            ...
            <div className="bg-blue-50 dark:bg-blue-900/20 border border-blue-200 dark:border-blue-800 rounded-lg p-4">
                <div className="flex gap-3">
                    <svg className="w-5 h-5 text-blue-600 dark:text-blue-400 flex-shrink-0 mt-0.5" fill="none"
                    ...
                    <div className="text-sm text-blue-800 dark:text-blue-300">
                        ...
                        <p className="mt-1">
                            Make sure your selected AI assistant is properly configured with API keys in your
